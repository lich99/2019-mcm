# -*- coding: utf-8 -*-
"""
Created on Sun Sep 15 18:20:37 2019
...
plt.legend(handles=[l1 , l2, l3, l4], labels=['Length = 300mm','Length = 400mm','Length = 500mm','Length = 600mm'], fontsize = 10, loc='upper right')
